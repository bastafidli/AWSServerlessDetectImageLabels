...
using AWSServerlessDetectImageLabels;
using Amazon.Lambda.S3Events;

namespace AWSServerlessDetectImageLabels.Tests
{
    public class FunctionTest
    {
        ...
        public async Task IntegrationTest()
        {
            ...
            var bucketName = "lambda-AWSServerlessDetectImageLabels-".ToLower() + DateTime.Now.Ticks;
